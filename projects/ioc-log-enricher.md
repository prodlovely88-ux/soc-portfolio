...
Инструмент разработан для ускорения первичного triage, индикаторов компрометации и формирования понятного отчёта для SOC-аналитика.
...
## Технический стек и решаемые задачи
...
The tool was developed to accelerate basic triage and generate clear reports for SOC analysis.
